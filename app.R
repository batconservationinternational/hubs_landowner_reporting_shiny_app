...
ui <- fluidPage(
  ...
  textInput("enter_project", "NABat Project Number", value = "",
            placeholder = "Enter NABat project number here"),
  ...
  textInput("enter_grts", "Enter GRTS Cell Number(s)", value = "", 
            placeholder = "Enter GRTS cell numbers seperated by a comma.",
            width = '50%'),
  textInput("enter_locations", "Survey Location Name(s)", 
            value = "", placeholder = "Enter survey location names seperated by a comma. Leave blank if you want all sites within the cell included.",
            width = '50%'),
